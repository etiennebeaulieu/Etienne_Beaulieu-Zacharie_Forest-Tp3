...
public class Input
{
	 ...
	 *
	 * @return Integer, un objet entier (Integer) contenant la valeur saisie ou
	 *         "null" si l'utilisateur a décidé d'annuler la saisie.
	 *
	 */
	 ...
	 * @param pQuestion chaîne permettant de poser une question.
	 *
	 * @return String un objet chaîne de caractères contenant la valeur saisie
	 *         ou "null" si l'utilisateur a décidé d'annuler la saisie.
	 */
