...
/**
 * Exemple d'utilisation potentielle de vos classes Cercle et Rectangle
 * Utilisation pédagogique pour des enfants du primaire. Voici une petite
 * application vous permettant de pratiquer le calcul du périmètre et de la
 * surface d'un rectangle ou d'un cercle. L'ensemble des informations sont
...
public class ApplicationAmusante
{
	...
	/**
	 * Cette méthode souhaite la bienvenue joueur
	 */
	...
	/**
	 * Cette méthode choisi aléatoirement entre un cercle ou un rectangle puis
	 * lui donne des mesure aléatoire.
	 * 
	 * @return Un rectangle ou un cercle
	 */
	...
	/**
	 * Cette méthode compare la surface entrée par l'utilisateur à celle du
	 * cercle
	 * 
	 * @param pCercle Cercle dont on souhaite connaitre la surface
	 */
	...
	/**
	 * Cette méthode compare le périmetre entrée par l'utilisateur à celui du
	 * cercle
	 * 
	 * @param pCercle Cercle dont on souhaite connaitre le pérmetre
	 */
	 ...
	 * rectangle
	 * 
	 * @param pRec Rectangle dont on souhaite connaitre la surface
	 */
	 ...
	 * rectangle
	 * 
	 * @param pRec Rectangle dont on souhaite connaitre le pérmetre
	 */
